...
```
### Tente usar <a href="https://github.com/CirqueiraDev/botnet-exploits">Scanners e Loaders</a> (não é possivel gerar um binario TOTALMENTE estático com python puro)
